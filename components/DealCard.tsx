...
export const DealCard: React.FC<DealCardProps> = ({ 
  ...
  return (
    <div 
      ...
      className="bg-white p-3 md:p-5 rounded-2xl md:rounded-[2rem] shadow-sm border border-slate-200 hover:shadow-xl hover:border-zorion-500/30 transition-all cursor-grab active:cursor-grabbing group animate-fade-in relative active:scale-[0.98] overflow-hidden"
    >
      ...
      <div className="flex flex-col gap-2 md:gap-3 pl-1 md:pl-0">
        ...
        <div className="flex justify-between items-end pt-2 mt-1 border-t border-slate-50">
          <div className="flex flex-col">
             ...
             <div className="font-black italic tracking-tighter leading-tight text-xs md:text-sm text-emerald-900 mt-0.5 whitespace-nowrap">
          ...
          <div className="text-right flex flex-col items-end relative z-30">
             ...
             <input 
               type="date"
               className="text-[9px] md:text-[10px] font-black text-slate-500 italic bg-transparent outline-none text-right cursor-pointer w-16 md:w-20 p-0 border-none focus:ring-0 relative z-40 hover:text-zorion-600 transition-colors"
